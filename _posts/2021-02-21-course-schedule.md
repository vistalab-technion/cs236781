...
1. Thursdays, 10:30-11:30, Taub 2 and Zoom (hybrid).  
   Supplementary lecture, presented by Chaim Baskin or Prof. Alex Bronstein.

1. Thursdays at 12:30-13:30, Taub 7 and Zoom (hybrid).  
   Tutorial, presented by Aviv Rosenberg.

1. Wednesdays at 11:30-12:30, Zoom only.  
   Tutorial, presented by Yaniv Nemcovsky.

Notes:
- Yaniv's tutorial group starts from the **second** week of the semester
  (April 7th due to Passover), so that it comes after each week's lecture.
- The in-class lectures are supplementary; the main lecture
